...
if (!(Test-Path "./dev/plugins/zoraxyresourcemonitor")) {
    New-Item -ItemType Directory -Path "./dev/plugins/zoraxyresourcemonitor"
}
...
Copy-Item "zoraxyresourcemonitor" -Destination "./dev/plugins/zoraxyresourcemonitor/"
